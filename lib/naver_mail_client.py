...
TRUSTED_SENDERS = [
    ...
    # P1 채널 명시 화이트리스트 (2026-04-28)
    "gtp.or.kr",          # 경기테크노파크 (본사 광역)
    "foodpolis.kr",        # 식품진흥원(국가식품클러스터) — 식품 R&D
    "mafra.go.kr",        # 농림축산식품부 (식품 정책 본가)
    "at.or.kr",            # aT 한국농수산식품유통공사 — K-Food
    "경기테크노파크", "식품진흥원", "농림축산식품부", "농수산식품",
    # P2 (광고·콘텐츠 등 보조)
    "gcon.or.kr", "경기콘텐츠진흥원",
    "kfia.or.kr", "한국식품산업협회",
]
