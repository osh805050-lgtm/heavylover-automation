...
0. **재실행 차단**: `docs/strategy/outputs/`에 기존 산출물 파일(예: `*-08_6m_roadmap.md`) 있으면 즉시 중단 후 사용자에게 "기존 갑론을박 산출물이 있습니다. 재실행 시 30~50분 + 수만 토큰 소모됩니다. 정말 재실행하시겠습니까?" 묻고 명시 승인 시에만 진행.
